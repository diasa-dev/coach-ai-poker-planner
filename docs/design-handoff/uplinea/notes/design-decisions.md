# Uplinea Design Decisions

## Brand

- Use the official Uplinea logo files from `assets/`.
...
- Uplinea is the approved product name. Preserve the wordmark, rising line/bar mark, spade detail, color palette, and typography from the brand guide.
...
Uplinea should feel like a compact performance operating system for professional online poker tournament players.

// EdgePlan — inline icon set. Two collections:
//
...
const Icon = {
  ...
  Logo:       (props = {}) => (
    <svg viewBox="0 0 200 200" fill="none" width={props.size || 20} height={props.size || 20} style={props.style}>
      <rect x="14" y="120" width="32" height="68" rx="16" fill={props.colour || '#0D1B2A'}/>
      <rect x="58" y="78" width="32" height="110" rx="16" fill={props.colour || '#1E3A8A'}/>
      <path d="M118 28 a16 16 0 0 1 32 0 V 124 L 134 144 L 118 124 Z" fill={props.colour || '#22C5D5'}/>
      <path d="M 134 96 C 134 108, 116 116, 108 130 C 100 144, 102 158, 114 162 C 124 165, 132 160, 134 152 C 134 158, 132 168, 124 174 L 144 174 C 136 168, 134 158, 134 152 C 136 160, 144 165, 154 162 C 166 158, 168 144, 160 130 C 152 116, 134 108, 134 96 Z" fill={props.colour || '#0D1B2A'}/>
    </svg>
  ),
};
...
const _brandWrap = (children) => ({ size = 28, mono = false, accent = '#22C5D5', style, className } = {}) => (
...
const BrandIcon = {
  ...
  Performance: _brandWrap(({ navy, accent }) => (
    <g fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M9 34 C 14 32, 18 30, 22 26 S 30 16, 38 10" stroke="#1E3A8A" strokeWidth="2.25"/>
      <polyline points="32,8 38,10 36,16" stroke="#1E3A8A" strokeWidth="2.25"/>

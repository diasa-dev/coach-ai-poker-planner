# EdgePlan Design Handoff

This folder is the visual handoff reference for the EdgePlan implementation.

Use it as a product and visual source of truth, not as production code to copy blindly.

## Source Files

- `source/EdgePlan_Print.pdf` - full printable prototype reference.
- `source/EdgePlan.zip` - original Claude Design export.
...
3. Design decisions in `docs/design-handoff/edgeplan/notes/design-decisions.md`.
4. Latest PDF/screens in `docs/design-handoff/edgeplan/source/EdgePlan_Print.pdf`.
5. Prototype source in `docs/design-handoff/edgeplan/source/EdgePlan.zip`.
